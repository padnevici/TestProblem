...
Func DrawFrameControl($hDC, $nLeft, $nTop, $nRight, $nBottom, $nType, $nState)
	...
	DllCall("user32.dll", "int", "DrawFrameControl", "hwnd", $hDC, "ptr", DllStructGetPtr($tRect), "int", $nType, "int", $nState)
...
Func DrawFocusRect($hDC, $nLeft, $nTop, $nRight, $nBottom)
	...
	DllCall("user32.dll", "int", "DrawFocusRect", "hwnd", $hDC, "ptr", DllStructGetPtr($tRect))
...
Func DrawText($hDC, $sText, $nLeft, $nTop, $nRight, $nBottom, $nFormat)
	...
	DllCall("user32.dll", "int", "DrawText", "hwnd", $hDC, "ptr", DllStructGetPtr($tText), "int", $nLen, "ptr", DllStructGetPtr($tRect), "int", $nFormat)
...
Func FillRect($hDC, $nLeft, $nTop, $nRight, $nBottom, $hBrush)
	...
	DllCall("user32.dll", "int", "FillRect", "hwnd", $hDC, "ptr", DllStructGetPtr($tRect), "hwnd", $hBrush)
...
Func InflateRect(ByRef $nLeft, ByRef $nTop, ByRef $nRight, ByRef $nBottom, $nX, $nY)
	...
	DllCall("user32.dll", "int", "InflateRect", "ptr", DllStructGetPtr($tRect), "int", $nX, "int", $nY)
